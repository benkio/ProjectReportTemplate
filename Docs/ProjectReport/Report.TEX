...
\newcommand{\xauthA}{Name1 Surname1}
\newcommand{\xauthB}{Name2 Surname2}
\newcommand{\xauthC}{Name3 Surname3}
...
\institute {  \xunibo\\\xaddrCE, \xcityCE\\\email{\{name1.surname1, name2.surname2, name3.surname3\}@mail.com }}
...
\input{4_Requirements.tex}

\input{5_Requirements_Analysis.tex}

\input{6_Problem_Analysis.tex}

\input{7_Work_Plan.tex}

\input{8_Project.tex}

\input{9_Implementation.tex}

\input{10_Testing.tex}
